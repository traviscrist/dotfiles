# Generated by Powerlevel10k configuration wizard on 2021-10-29 at 17:23 PDT.
...
() {
  ...
  # if using this. You might also like POWERLEVEL9K_PROMPT_ADD_NEWLINE=7 for more compact
  # prompt.
